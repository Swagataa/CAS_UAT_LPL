...
public class FI_Verification_LPL extends BrowserSetup{
	...
	//	searchappId.sendKeys(app_id);
		...
		WebElement Office_verification = driver.findElement(By.xpath("//form[@id='formID28']/p[3]/font[1]/a[1]"));
		...
		WebElement residence_verification = driver.findElement(By.xpath("//form[@id='formID28']/p[4]/font[1]/a[1]"));
