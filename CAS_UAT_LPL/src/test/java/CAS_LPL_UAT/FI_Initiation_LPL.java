...
public class FI_Initiation_LPL extends BrowserSetup 
{
...
//		searchappId.sendKeys(app_id);
		...
		WebElement btnOpenCountry = driver.findElement(By.xpath("//table[@class='TABLEATTRIBUTES']/tbody/tr[2]/td[5]/a[1]"));
		...
		List<String> Residenceverificationwindow = new ArrayList<String>(driver.getWindowHandles());
		 ...
		 /*------------------- Office Verification --------------*/
			 ...
			 WebElement Officeverfication =  driver.findElement(By.xpath("//table[@class='TABLEATTRIBUTES']/tbody/tr[2]/td[6]/a[1]"));
				...
				List<String> Officeverficationwindow = new ArrayList<String>(driver.getWindowHandles());
				 ...
				 Thread.sleep(1000);
				 /*----------- Return From Office Verification-------------- */
